# -*- coding: utf-8 -*-
"""Работающая (2 блока) with red line

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1QqslS2Zc959dNJp9r3C0EZHYMltwRIZP
"""
...
def calculate_norm_vel_innerbound(G, k, eta):
    ...
    return norm_vel_centerline * (2 * eta / (1 + eta)) * (1 + a) + (1 / k) * ((-1 / eta) + (2 * (1 + a)) / (1 + eta) + (1 + a) / eta * np.log(((1 - eta) / (1 + eta)) * (1 + a / a)))
...
# Define the x-axis range for the red line (10^3 to 10^5)
x_range_red = np.logspace(2, 4, num=100)  # Updated range from 10^3 to 10^5

# Calculate y_drag_red using the specified function
y_drag_red = [19 * math.log(x, 10) - 32.4 for x in x_range_red]

# Plot the red line
ax.plot(x_range_red, y_drag_red, color='red', label='drag reduction asymptote ')

# Add a legend for the red line in the lower right corner
